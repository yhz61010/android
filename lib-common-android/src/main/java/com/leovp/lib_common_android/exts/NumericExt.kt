...
fun getRatio(size: Size, delimiters: String = ":", swapResult: Boolean = false): String {
    return com.leovp.lib_common_kotlin.exts.getRatio(size.width, size.height, delimiters, swapResult)
}

fun getRatio(size: SmartSize, delimiters: String = ":", swapResult: Boolean = false): String {
    return com.leovp.lib_common_kotlin.exts.getRatio(size.long, size.short, delimiters, swapResult)
}