 ...
 * 渐变色 - 优化数据传递
 */
class L4U2BetterGradientRenderer(@Suppress("unused") private val ctx: Context) : BaseRenderer() {
    override fun getTagName(): String = L4U2BetterGradientRenderer::class.java.simpleName
