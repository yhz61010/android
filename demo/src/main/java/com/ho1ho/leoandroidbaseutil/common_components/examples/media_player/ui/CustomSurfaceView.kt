package com.ho1ho.leoandroidbaseutil.common_components.examples.media_player.ui
...
class CustomSurfaceView @JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null, defStyle: Int = 0) :
    ...
    fun setDimension(width: Int, height: Int) {
        ...
        LLog.d(TAG, "setDimension width=$width height=$height ratio=$aspectRatio realWidth=$realWidth realHeight=$realHeight ")
