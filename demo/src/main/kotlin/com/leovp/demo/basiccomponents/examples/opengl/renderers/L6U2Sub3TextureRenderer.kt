 ...
 * 纹理渲染 - 蒙版遮罩
 */
class L6U2Sub3TextureRenderer(@Suppress("unused") private val ctx: Context) : BaseRenderer() {
    override fun getTagName(): String = L6U2Sub3TextureRenderer::class.java.simpleName
