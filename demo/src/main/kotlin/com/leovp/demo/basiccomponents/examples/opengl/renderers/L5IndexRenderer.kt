...
import com.leovp.opengl.util.createShortBuffer
 ...
 */
class L5IndexRenderer(@Suppress("unused") private val ctx: Context) : BaseRenderer() {
    override fun getTagName(): String = L5IndexRenderer::class.java.simpleName
