...
//        connectionListener: NettyConnectionListener,
//        retryStrategy: RetryStrategy = ConstantRetry()
//    ) : this(webSocketUri.port, connectionListener, retryStrategy) {
//        this.webSocketUri = webSocketUri
//        LLog.w(tag, "WebSocket mode. Uri=${webSocketUri} host=${webSocketUri.host} port=${webSocketUri.port}")
//    }
//
//    init {
//        bootstrap.localAddress(InetSocketAddress(port))
...
//                        pipeline.addFirst(sslCtx.newHandler(serverSocketChannel.alloc(), InetSocketAddress(port).hostString, port))
//                    }
