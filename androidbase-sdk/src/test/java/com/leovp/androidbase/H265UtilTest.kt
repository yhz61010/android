...
class H265UtilTest {
    ...
    fun h265Test() {
        ...
        val seiByteArray = byteArrayOf(0, 0, 0, 1, 0x4E, 1, 5, 0x1A, 0x47, 0x56, 0x4A, 0xDC.toByte(), 0x5C, 0x4C, 0x43, 0x3F)
        ...
        Assert.assertArrayEquals(byteArrayOf(0, 0, 0, 1, 0x4E, 1, 5, 0x1A, 0x47, 0x56, 0x4A, 0xDC.toByte(), 0x5C, 0x4C, 0x43, 0x3F), seiBytes)
