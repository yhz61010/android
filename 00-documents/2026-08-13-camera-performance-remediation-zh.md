...
**验证结果（2026-08-17，已通过）**：维护者确认本轮 Camera2Live 照片、预览和录像真机测试均通过。照片方向
与水平镜像正确；后置横屏录像方向和颜色保持正确；前置横屏已按横屏输出，水平镜像和颜色正确，且未出现
花屏。本项真机门禁已解除。不同 `sensorOrientation`（90°/270°）机型及 YUV420P/YUV420SP 设备的扩大覆盖
仍保留在发布回归矩阵中。
