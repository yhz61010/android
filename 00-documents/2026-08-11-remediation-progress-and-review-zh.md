...
| **本轮剩余问题** | R-6 / R-10 + R-5 深改 + R-9 重构 | ❌ 待修复 | 见 §3（R-1/R-2/R-3、R-4/R-7/R-8 已修复；R-5 部分修复；R-9 为维护性重构） |

累计：72 项中完成 **56 项**（P0+P1+P2）；本轮审查 R-1/R-2/R-3、R-4/R-7/R-8 已修复、
R-5 部分修复；剩余 R-6（清理）、R-10（低）、R-5 结构性改动、R-9（维护性重构）+ P3 约 16 项。
...
2. ✅ **R-4 / R-7 / R-8 已修复,R-5 部分修复**（2026-08-11，见 CHANGELOG）。
   剩余:R-6 / R-10（低优）、R-5 结构性改动（需先补测试）、R-9（维护性重构）。
