...
DECLARE_ALIGNED(SBC_ALIGN, int32_t, ff_sbcdsp_joint_bits_mask
)[8] = {
...
DECLARE_ALIGNED(SBC_ALIGN, uint8_t, ff_sbc_input_perm_4
)[2][8] = {
PERM(7, 3, 6, 4),
PERM(0, 2, 1, 5)
};

DECLARE_ALIGNED(SBC_ALIGN, uint8_t, ff_sbc_input_perm_8
)[4][8] = {
PERM(15, 7, 14, 8),
PERM(13, 9, 12, 10),
PERM(11, 3, 6, 0),
