...
import com.leovp.min_base_sdk.bytes.*
...
class BytesConversionUnitTest {
    ...
    fun otherTests() {
        ...
        assertArrayEquals(byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(5))
        assertArrayEquals(byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(6))
        assertArrayEquals(byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(7))
        assertArrayEquals(byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(8))

        assertArrayEquals(byteArrayOf(0x01), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(1, 1))
        assertArrayEquals(byteArrayOf(0x02, 0x03, 0x04), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(3, 2))
        assertArrayEquals(byteArrayOf(0x03, 0x04, 0x15), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(3, 3))
        assertArrayEquals(byteArrayOf(0x02, 0x03, 0x04, 0x15, 0x16, 0x36), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(6, 2))
        assertArrayEquals(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x15, 0x16), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(6, 1))
        assertArrayEquals(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(7, 1))
        assertArrayEquals(byteArrayOf(0x15, 0x16), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(2, 5))
        assertArrayEquals(byteArrayOf(0x02, 0x03, 0x04, 0x15, 0x16, 0x36), byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(6, 2))
    }
}
