...
import com.leovp.opengl.filter.BaseFilter
import com.leovp.opengl.filter.CloneFullFilter
import com.leovp.opengl.filter.ClonePartFilter
import com.leovp.opengl.filter.CrossFilter
import com.leovp.opengl.filter.GrayFilter
import com.leovp.opengl.filter.InverseFilter
import com.leovp.opengl.filter.LightUpFilter
import com.leovp.opengl.filter.ScaleFilter
import com.leovp.opengl.filter.TranslateFilter
 ...
 * 滤镜渲染
 */
class L8U1FilterRenderer(@Suppress("unused") private val ctx: Context) : BaseRenderer() {
    override fun getTagName(): String = L8U1FilterRenderer::class.java.simpleName
