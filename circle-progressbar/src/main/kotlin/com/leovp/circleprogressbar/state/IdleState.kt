package com.leovp.circleprogressbar.state
...
import com.leovp.circleprogressbar.R
...
class IdleState(view: View) : State(view) {
    override fun status(): Type = Type.STATE_IDLE
