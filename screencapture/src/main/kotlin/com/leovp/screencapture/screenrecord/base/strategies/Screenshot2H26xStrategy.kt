...
class Screenshot2H26xStrategy private constructor(private val builder: Builder) : ScreenProcessor {
    ...
    private fun releaseOwnedResources(stopEncoder: Boolean) {
        ...
        // One block, so the encoder and the writer disappear together and there is no state in
        // which one is detached and the other is not. Assigning these vals from inside is legal:
        // kotlin.synchronized declares an EXACTLY_ONCE contract that definite assignment reads.
