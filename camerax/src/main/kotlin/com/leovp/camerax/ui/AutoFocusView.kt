 ...
 * 对焦动图显示
 */
class AutoFocusView(context: Context, attrs: AttributeSet? = null) :
    AppCompatImageView(context, attrs) {
    private var focusImg = NO_ID
    private var focusSucceedImg = NO_ID
    private var focusFailedImg = NO_ID
    private val focusAnimation: Animation = AnimationUtils.loadAnimation(
        context,
    ...
    init {
        ...
        focusSucceedImg =
            typedArray.getResourceId(R.styleable.AutoFocusView_focusSuccessDrawable, NO_ID)
        focusFailedImg =
            typedArray.getResourceId(R.styleable.AutoFocusView_focusFailDrawable, NO_ID)
        typedArray.recycle()
