...
class BytesConversionUnitTest {
    ...
    fun shortArray2ByteArray() {
        assertArrayEquals(
            ...
            shortArrayOf(0x0100, 0x0302, 0x0504).toByteArrayLE()
        )
        assertArrayEquals(
            byteArrayOf(0xA, 0xB, 0xC, 0xD, 0xE, 0xF),
            shortArrayOf(0x0B0A, 0x0D0C, 0x0F0E).toByteArrayLE()
        )
        assertArrayEquals(
            byteArrayOf(
                0x30, 0x31, 0x42, 0x43, 0xA5.toByte(),
                0xDE.toByte(), 0x5A, 0xBA.toByte()
            ),
        ...
        assertArrayEquals(
            byteArrayOf(
                ...
                0xEE.toByte(), 0xFF.toByte(), 0xFF.toByte()
            ),
            shortArrayOf(0xEEDD.toShort(), 0xEEFF.toShort(), 0xFFFF.toShort()).toByteArrayLE()
        )

        assertArrayEquals(
            byteArrayOf(0, 1, 2, 3, 4, 5).toShortArray(),
            shortArrayOf(0x0001, 0x0203, 0x0405)
        )
        assertArrayEquals(
            byteArrayOf(0xA, 0xB, 0xC, 0xD, 0xE, 0xF).toShortArray(),
            shortArrayOf(0x0A0B, 0x0C0D, 0x0E0F)
        )
        assertArrayEquals(
            byteArrayOf(
                0x30, 0x31, 0x42, 0x43, 0xA5.toByte(),
    ...
    fun byteArray2ShortArray() {
        assertArrayEquals(
            shortArrayOf(0x0100, 0x0302, 0x0504),
            byteArrayOf(0, 1, 2, 3, 4, 5).toShortArrayLE()
        )
        assertArrayEquals(
            shortArrayOf(0x0B0A, 0x0D0C, 0x0F0E),
            byteArrayOf(0xA, 0xB, 0xC, 0xD, 0xE, 0xF).toShortArrayLE()
        )
        assertArrayEquals(
    ...
    fun numberToBytes() {
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0F),
            15L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            15L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10),
            16L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            16L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F),
            127L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            127L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80.toByte()),
            128L.toBytes()
        )
        assertArrayEquals(
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFE.toByte()),
            254L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0xFE.toByte(), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            254L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF.toByte()),
            255L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0xFF.toByte(), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            255L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00),
            256L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            256L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xFF.toByte()),
            511L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0xFF.toByte(), 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            511L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00),
            512L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            512L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x4A),
            586L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0x4A, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            586L.toBytesLE()
        )

        assertArrayEquals(
            byteArrayOf(0xDE.toByte(), 0xA5.toByte()),
            ((0xDEA5).toShort()).toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0xA5.toByte(), 0xDE.toByte()),
            (0xDEA5.toShort()).toBytesLE()
        )
        assertArrayEquals(
            byteArrayOf(0xFF.toByte(), 0xFF.toByte()),
            (65535.toShort()).toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0xFF.toByte(), 0xFF.toByte()),
            (65535.toShort()).toBytesLE()
        )
        assertArrayEquals(
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00),
            65536L.toBytes()
        )
        assertArrayEquals(
        ...
        assertArrayEquals(
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x09, 0x32),
            67890L.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0x32, 0x09, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00),
            67890L.toBytesLE()
        )
        ...
        assertArrayEquals(
            byteArrayOf(0x40, 0xE2.toByte()),
            (123456.toShort()).toBytesLE()
        )
        assertArrayEquals(
        ...
        assertArrayEquals(
            ...
            (1234567890.toShort()).toBytesLE()
        )
        assertArrayEquals(
            byteArrayOf(0x49, 0x96.toByte(), 0x02, 0xD2.toByte()),
            1234567890.toBytes()
        )
        assertArrayEquals(
            byteArrayOf(0xD2.toByte(), 0x02, 0x96.toByte(), 0x49),
            1234567890.toBytesLE()
        )
        assertArrayEquals(
            byteArrayOf(
    ...
    fun bytesToNumber() {
        ...
        assertEquals(
            0L,
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00).readLong()
        )
        assertEquals(
            0L,
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00).readLongLE()
        )
        ...
        assertEquals(
            1L,
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01).readLong()
        )
        assertEquals(
            1L,
            byteArrayOf(0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00).readLongLE()
        )
        assertEquals(
            256L,
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00).readLong(1)
        )
        assertEquals(
            1L,
            byteArrayOf(0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00).readLongLE(1)
        )
        ...
        assertEquals(
            127L,
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F).readLong()
        )
        assertEquals(
            127L,
            byteArrayOf(0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00).readLongLE()
        )
        assertEquals(
            8323330L,
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x01, 0x02)
                .readLong(2)
        )
        assertEquals(
            144396663052566530L,
            byteArrayOf(0x7F, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x02)
                .readLongLE(2)
        )
        ...
        assertEquals(
            128L,
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80.toByte()).readLong()
        )
        assertEquals(
            128L,
            byteArrayOf(0x80.toByte(), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00).readLongLE()
        )
        ...
        assertEquals(
            255L,
            byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF.toByte()).readLong()
        )
        assertEquals(
            255L,
            byteArrayOf(0xFF.toByte(), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00).readLongLE()
        )
    ...
    fun otherTests() {
        assertArrayEquals(
            byteArrayOf(0x7F),
            byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(1)
        )
        assertArrayEquals(
            byteArrayOf(0x7F, 0x01),
            byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(2)
        )
        assertArrayEquals(
            byteArrayOf(0x7F, 0x01, 0x02),
            byteArrayOf(0x7F, 0x01, 0x02, 0x03, 0x04, 0x15, 0x16, 0x36).readBytes(3)
        )
        assertArrayEquals(
