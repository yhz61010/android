...
class PrefActivity : BaseDemonstrationActivity() {
    ...
    private fun defaultPref() {
        ...
        LogContext.log.d(ITAG, "pref boolean=${PrefContext.pref.getObject("boolean", false)}")
        LogContext.log.d(ITAG, "pref long=${PrefContext.pref.getObject("long", 0L)}")
        LogContext.log.d(ITAG, "pref int=${PrefContext.pref.getObject("int", 0)}")
        LogContext.log.d(ITAG, "pref float=${PrefContext.pref.getObject("float", 0f)}")
    ...
    private fun mmkvPref() {
        ...
        LogContext.log.d(ITAG, "mmkv pref boolean=${PrefContext.pref.getObject("mmkv_boolean", false)}")
        LogContext.log.d(ITAG, "mmkv pref long=${PrefContext.pref.getObject("mmkv_long", 0L)}")
        LogContext.log.d(ITAG, "mmkv pref int=${PrefContext.pref.getObject("mmkv_int", 0)}")
        LogContext.log.d(ITAG, "mmkv pref float=${PrefContext.pref.getObject("mmkv_float", 0f)}")
