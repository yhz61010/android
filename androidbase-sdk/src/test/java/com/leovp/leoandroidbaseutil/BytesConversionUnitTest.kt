...
class BytesConversionUnitTest {
    ...
    @Test
    fun hexConverter() {
        assertEquals("1,9,A,10,13,1A,36,78,D3,BA", byteArrayOf(0x01, 0x09, 0x0A, 0x10, 0x13, 0x1A, 0x36, 0x78, 0xD3.toByte(), 0xBA.toByte()).toHexStringLE())
        assertEquals("10,90,A0,1,31,A1,63,87,3D,AB", byteArrayOf(0x01, 0x09, 0x0A, 0x10, 0x13, 0x1A, 0x36, 0x78, 0xD3.toByte(), 0xBA.toByte()).toHexString())

        assertEquals("1,9,A,10,13,1A,36,78,D3,BA", byteArrayOf(0x01, 0x09, 0x0A, 0x10, 0x13, 0x1A, 0x36, 0x78, 0xD3.toByte(), 0xBA.toByte()).toHexStringLE(false))
        assertEquals("10,90,A0,1,31,A1,63,87,3D,AB", byteArrayOf(0x01, 0x09, 0x0A, 0x10, 0x13, 0x1A, 0x36, 0x78, 0xD3.toByte(), 0xBA.toByte()).toHexString(false))

        assertEquals("01,09,0A,10,13,1A,36,78,D3,BA", byteArrayOf(0x01, 0x09, 0x0A, 0x10, 0x13, 0x1A, 0x36, 0x78, 0xD3.toByte(), 0xBA.toByte()).toHexStringLE(true))
        assertEquals("10,90,A0,01,31,A1,63,87,3D,AB", byteArrayOf(0x01, 0x09, 0x0A, 0x10, 0x13, 0x1A, 0x36, 0x78, 0xD3.toByte(), 0xBA.toByte()).toHexString(true))

        assertEquals("01090A10131A3678D3BA", byteArrayOf(0x01, 0x09, 0x0A, 0x10, 0x13, 0x1A, 0x36, 0x78, 0xD3.toByte(), 0xBA.toByte()).toHexStringLE(true, ""))
        assertEquals("1090A00131A163873DAB", byteArrayOf(0x01, 0x09, 0x0A, 0x10, 0x13, 0x1A, 0x36, 0x78, 0xD3.toByte(), 0xBA.toByte()).toHexString(true, ""))
    ...
    fun bytesToNumber() {
        ...
        assertEquals(144396663052566530L, byteArrayOf(0x7F, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x02).readLongLE(2))
