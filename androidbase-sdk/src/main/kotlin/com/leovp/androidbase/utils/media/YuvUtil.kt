...
object YuvUtil {
    ...
    //            LogContext.log.d(TAG, "plane[" + nPlane + "]: length " + imgYUV420.getPlanes()[nPlane].getBuffer().remaining() +
//                ", strides: " + imgYUV420.getPlanes()[nPlane].getPixelStride() + " " + imgYUV420.getPlanes()[nPlane].getRowStride());
    //        }
    //
