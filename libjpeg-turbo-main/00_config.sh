...
echo "ANDROID_NDK_ROOT_STR_ARRAY=${ANDROID_NDK_ROOT_STR_ARRAY[*]}"
# Get last element if bash version is 4.1+
#ANDROID_NDK_FULL_VERSION=${ANDROID_NDK_ROOT_STR_ARRAY[-1]}
ANDROID_NDK_FULL_VERSION=${ANDROID_NDK_ROOT_STR_ARRAY[${#ANDROID_NDK_ROOT_STR_ARRAY[@]}-1]}
echo "ANDROID_NDK_FULL_VERSION=$ANDROID_NDK_FULL_VERSION"

ANDROID_NDK_VERSION=`echo $ANDROID_NDK_FULL_VERSION | cut -d '.' -f 1`
echo "ANDROID_NDK_MAJOR_VERSION=$ANDROID_NDK_VERSION"
