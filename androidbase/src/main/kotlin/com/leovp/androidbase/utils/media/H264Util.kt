 ...
 *
 * 综上所述，帧类型判断方法：
 * NALU类型 & 0001 1111(0x1F)(31) 即 NALU类型 & 31(十进制)
 *
 * 例如，I帧判断方法：
 * 0110 0101(0x65) & 0001 1111(0x1F) = 0000 0101(0x5)，即 NALU类型 & 31(十进制) = 5(十进制) 即为I帧。
 * SPS 帧判断方法：
 * 0110 0111(0x67) & 0001 1111(0x1F) = 0000 0111(0x7)，即 NALU类型 & 31(十进制) = 7(十进制) 即为SPS帧。
 * PPS 帧判断方法：
 * 0110 1000(0x68) & 0001 1111(0x1F) = 0000 1000(0x8)，即 NALU类型 & 31(十进制) = 8(十进制) 即为PPS帧。
 *
...
object H264Util {
     ...
     * Example:
     * 0,0,0,1,67,42,80,28,DA,1,10,F,1E,5E,6A,A,C,A,D,A1,42,6A,0,0,0,1,68,CE,
     * 6,E2,0,0,0,1,65,8B,4,B0,7C,F1
     *
