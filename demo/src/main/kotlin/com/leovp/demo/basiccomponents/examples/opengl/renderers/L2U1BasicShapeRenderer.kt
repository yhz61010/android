 ...
 * 点击屏幕查看效果
 */
class L2U1BasicShapeRenderer(@Suppress("unused") private val ctx: Context) : BaseRenderer() {
    override fun getTagName(): String = L2U1BasicShapeRenderer::class.java.simpleName
    ...
    private val maxDrawCount = POINT_DATA.size / TWO_DIMEN_POS_COMPONENT_COUNT
