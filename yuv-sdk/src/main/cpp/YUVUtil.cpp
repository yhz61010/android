...
JNIEXPORT jbyteArray Convert_To_I420(JNIEnv *env, jobject thiz, jbyteArray yuvData, jint format, jint w, jint h, jint type) {
...
static JNINativeMethod methods[] = {
        {"convertToI420",               "([BIIII)[B", (void *) Convert_To_I420},
