...
int android420ToI420(const uint8_t *src_android420_data, jint src_pixel_stride_uv, jint width, jint height, uint8_t *dst_i420_data, jboolean vertically_flip, jint degree) {
    ...
    return libyuv::Android420ToI420Rotate(src_i420_y_data, width,
...
int convertToI420(const uint8_t *src_yuv_data, jint src_length, jint format, jint width, jint height, uint8_t *dst_i420_data, jboolean vertically_flip, jint degree) {
    ...
    int base_dst_stride_dimension = width;
    if (90 == degree || 270 == degree) base_dst_stride_dimension = height;
    return libyuv::ConvertToI420(src_yuv_data, src_length,
                          dst_i420_y_data, base_dst_stride_dimension,
                          dst_i420_u_data, base_dst_stride_dimension >> 1,
                          dst_i420_v_data, base_dst_stride_dimension >> 1,
                          0, 0,
...
int mirrorI420(const uint8_t *src_i420_data, jint width, jint height, uint8_t *dst_i420_data) {
    ...
    return libyuv::I420Mirror(src_i420_y_data, width,
                       src_i420_u_data, width >> 1,
                       src_i420_v_data, width >> 1,
...
int flipVerticallyI420(const uint8_t *src_i420_data, jint width, jint height, uint8_t *dst_i420_data) {
    ...
    return libyuv::I420Copy(src_i420_y_data, width,
                     src_i420_u_data, width >> 1,
                     src_i420_v_data, width >> 1,
                     dst_i420_y_data, width,
                     dst_i420_u_data, width >> 1,
...
int rotateI420(const uint8_t *src_i420_data, jint width, jint height, uint8_t *dst_i420_data, jint degree) {
    ...
    if (degree == libyuv::kRotate90 || degree == libyuv::kRotate270) {
        return libyuv::I420Rotate(src_i420_y_data, width,
                           src_i420_u_data, width >> 1,
                           src_i420_v_data, width >> 1,
...
int scaleI420(const uint8_t *src_i420_data, jint width, jint height,
    ...
    return libyuv::I420Scale(src_i420_y_data, width,
                      src_i420_u_data, width >> 1,
                      src_i420_v_data, width >> 1,
                      width, height,
...
int cropI420(const uint8_t *src_i420_data, jint src_length, jint width, jint height,
    ...
    return libyuv::ConvertToI420(src_i420_data, src_length,
                          dst_i420_y_data, dst_width,
                          dst_i420_u_data, dst_width >> 1,
                          dst_i420_v_data, dst_width >> 1,
                          left, top,
...
int i420ToNv21(const uint8_t *src_i420_data, jint width, jint height, uint8_t *dst_nv21_data) {
    ...
    return libyuv::I420ToNV21(src_i420_y_data, width,
                       src_i420_u_data, width >> 1,
                       src_i420_v_data, width >> 1,
...
int i420ToNv12(const uint8_t *src_i420_data, jint width, jint height, uint8_t *dst_nv12_data) {
    ...
    return libyuv::I420ToNV12(src_i420_y_data, width,
                       src_i420_u_data, width >> 1,
                       src_i420_v_data, width >> 1,
...
int nv21ToI420(const uint8_t *src_nv21_data, jint width, jint height, uint8_t *dst_i420_data) {
    ...
    return libyuv::NV21ToI420(src_nv21_y_data, width,
...
int nv12ToI420(const uint8_t *src_nv12_data, jint width, jint height, uint8_t *dst_i420_data, jint degree) {
    ...
    const jint output_width = degree == libyuv::kRotate90 || degree == libyuv::kRotate270
                              ? height
                              : width;
    jint dst_y_stride = output_width;
    jint dst_u_stride = output_width >> 1;
    jint dst_v_stride = dst_u_stride;

    return libyuv::NV12ToI420Rotate(src_y_data, src_stride_y,
...
int mirrorNV12(const uint8_t *src_nv12_data, jint width, jint height, uint8_t *dst_nv12_data) {
    ...
    return libyuv::NV12Mirror(src_y_data, width,
                       src_uv_data, width,
                       dst_nv12_y_data, width,
                       dst_nv12_uv_data, width,
                       width, height);
...
int scaleNV12(const uint8_t *src_nv12_data, jint width, jint height,
    ...
    return libyuv::NV12Scale(src_y_data, width,
                      src_uv_data, width,
                      width, height,
...
int nv21ToNV12(const uint8_t *src_nv21_data, jint width, jint height, uint8_t *dst_nv12_data) {
    ...
    return libyuv::NV21ToNV12(src_nv21_y_data, width,
                       src_nv21_vu_data, width,
                       dst_nv12_y_data, width,
                       dst_nv12_uv_data, width,
                       width, height);
...
int i420ToRgb24(const uint8_t *src_i420_data, jint width, jint height, uint8_t *dst_rgb24_data) {
    ...
    return libyuv::I420ToRGB24(src_i420_y_data, width,
                        src_i420_u_data, width >> 1,
                        src_i420_v_data, width >> 1,
                        dst_rgb24_data, width * 3,
                        width, height);
}
