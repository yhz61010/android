...
void ff_jref_idct_put_msa(uint8_t * dest, ptrdiff_t
stride,
int16_t *block
);
void ff_jref_idct_add_msa(uint8_t * dest, ptrdiff_t
stride,
int16_t *block
);
...
void ff_simple_idct_put_msa(uint8_t * dest, ptrdiff_t
stride_dst,
int16_t *block
);
void ff_simple_idct_add_msa(uint8_t * dest, ptrdiff_t
stride_dst,
int16_t *block
);
...
void ff_simple_idct_put_8_mmi(uint8_t * dest, ptrdiff_t
line_size,
int16_t *block
);
void ff_simple_idct_add_8_mmi(uint8_t * dest, ptrdiff_t
line_size,
int16_t *block
);
