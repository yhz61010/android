...
import com.leovp.opengl.util.GLConstants.RGB_COLOR_COMPONENT_COUNT
 ...
 * 渐变色
 */
class L4U1BasicGradientRenderer(@Suppress("unused") private val ctx: Context) : BaseRenderer() {
    override fun getTagName(): String = L4U1BasicGradientRenderer::class.java.simpleName
    ...
    override fun onDrawFrame(unused: GL10) {
        ...
        GLES20.glDrawArrays(
            ...
            POINT_DATA.size / TWO_DIMEN_POS_COMPONENT_COUNT
        )
