...
class L4_2_BetterGradientRenderer(@Suppress("unused") private val ctx: Context) : BaseRenderer() {
    ...
    private companion object {
         ...
         */
        private val STRIDE = (TWO_DIMENSIONS_POSITION_COMPONENT_COUNT + RGB_COLOR_COMPONENT_COUNT) * Float.SIZE_BYTES
    }
    ...
    override fun onSurfaceCreated(unused: GL10, config: EGLConfig) {
        ...
        // 6. 数据缓冲区
        GLES20.glVertexAttribPointer(aPositionLocation, TWO_DIMENSIONS_POSITION_COMPONENT_COUNT, GLES20.GL_FLOAT, false, STRIDE, vertexData)
        GLES20.glEnableVertexAttribArray(aPositionLocation)

        // 将数组的初始读取位置右移 2 位，所以数组读取的顺序是 r1, g1, b1, x2, y2, r2, g2, b2...
        vertexData.position(TWO_DIMENSIONS_POSITION_COMPONENT_COUNT)
