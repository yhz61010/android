 ...
 * 纹理渲染 - 单个纹理单元
 */
class L6U2Sub1TextureRenderer(@Suppress("unused") private val ctx: Context) : BaseRenderer() {
    override fun getTagName(): String = L6U2Sub1TextureRenderer::class.java.simpleName
    ...
    private fun drawFireL() {
        ...
        GLES20.glDrawArrays(
            ...
            POINT_DATA_FIRE_L.size / TWO_DIMEN_POS_COMPONENT_COUNT
        )
    }
